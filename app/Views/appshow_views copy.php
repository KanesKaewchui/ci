...
<body class="bg-pink-600 flex-col justify-center items-start h-screen p-0 m-0">
    <div class="bg-pink-200 w-3/5 mx-auto">
        ...
        <div class="flex flex-col items-center">
            ...
            <div class="flex flex-wrap justify-center gap-20 w-full max-w-screen-xl mx-auto md:px-10 md:py-5">
                <div class="flex flex-col items-center relative ">
                    <img class="rounded-full w-48 max-md:w-auto h-48 max-md:h-auto  mb-2 shadow-lg border-8 border-gray-400" src="<?php echo $users[1]['user_logo']; ?>" alt="User Logo">
                ...
                <tbody>
                    ...
                    <?php foreach ($top_users as $user) : ?>
                        ...
                        <tr class="<?php echo $index % 2 == 0 ? 'bg-pink-200' : 'bg-pink-100'; ?>">
                            ...
                            <td class=" px-4 py-2"><?php echo DateThai($user['updatetime']); ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
