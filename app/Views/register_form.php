...
<body class="bg-gray-100">
    <div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md mt-16">
        ...
        <form action="/Movie_test/register" method="POST" class="space-y-4">
            ...
            <div class="flex justify-between items-center">
                ...
                <input type="date" name="birthday" id="birthday" required class="border border-gray-300 p-2 rounded w-64">
            </div>
